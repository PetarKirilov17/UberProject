...
namespace Uber.Infrastructure.Migrations
{
    ...
    [Migration("20231023123948_AddingIsFreeFieldInVehicle")]
    partial class AddingIsFreeFieldInVehicle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Client", b =>
                {
                    ...
                    b.Property<decimal>("Balance")
                        ...
                        .HasComment("Field that contains the current balance of the client");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Driver", b =>
                {
                    ...
                    b.Property<bool>("IsFree")
                        ...
                        .HasComment("Field that tells whether the driver is free and therefore has the opportunity to accpet the order");
                    ...
                    b.Property<decimal>("Profit")
                        ...
                        .HasComment("Field that contains the profit that the driver has made from their orders");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.DriversOrders", b =>
                {
                    b.Property<int>("DriverId")
                        .HasColumnType("integer")
                        .HasColumnName("driver_id")
                        .HasComment("Used to describe the 'many-to-many' relationship between the Driver and the Order. Used both as primary key and foregin to make the relationship with the driver.");

                    b.Property<int>("OrderId")
                        .HasColumnType("integer")
                        .HasColumnName("order_id")
                        .HasComment("Used to describe the 'many-to-many' relationship between the Driver and the Order. Used both as primary key and foregin to make the relationship with the order.");

                    b.HasKey("DriverId", "OrderId")
                        .HasName("pk_drivers_orders");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_drivers_orders_order_id");

                    b.ToTable("drivers_orders", (string)null);

                    b.HasComment("This is a class that describes the mapping Entity between the Driver and the Order");
                });
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Order", b =>
                {
                    ...
                    b.Property<int>("OrderStatusId")
                        ...
                        .HasComment("Foreign Key that describes a 'one-to-many' relationship between the Order and the OrderStatus. Contains information about the current status of the order.");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.OrderStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("status_id")
                        .HasComment("Identfier of the status.");
                    ...
                    b.Property<string>("Label")
                        ...
                        .HasColumnName("label")
                        .HasComment("Label that contains the value of the status.");
                    ...
                    b.HasComment("This is a class that describes the OrderStatus Entity in the application.");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Vehicle", b =>
                {
                    ...
                    b.Property<bool>("IsFree")
                        .HasColumnType("boolean")
                        .HasColumnName("is_free")
                        .HasComment("Field that tells whether the vehice is free at the moment.");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.DriversOrders", b =>
                {
                    b.HasOne("Uber.Infrastructure.Data.Models.Driver", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_drivers_orders_drivers_driver_id");

                    b.HasOne("Uber.Infrastructure.Data.Models.Order", "Order")
                        .WithMany("DriversWhoHaveCancelled")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_drivers_orders_orders_order_id");
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Order", b =>
                {
                    ...
                    b.HasOne("Uber.Infrastructure.Data.Models.OrderStatus", "OrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Uber.Infrastructure.Data.Models.Order", b =>
                {
                    b.Navigation("DriversWhoHaveCancelled");
                });
